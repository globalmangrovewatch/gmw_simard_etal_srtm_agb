...
class GenTaskCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for img_tile in img_tiles:
            ...
            tif_img = os.path.join(kwargs['tif_path'], "{}.tif".format(tile_base_name))
            out_file = os.path.join(kwargs['out_path'], "{}_chk.json".format(tile_base_name))
    ...
    def run_gen_commands(self):
        ...
        for vec_lyr in vec_lyrs:
            self.gen_command_info(img_tiles='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_agb/agb_{}/*.kea'.format(vec_lyr),
                                  tif_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_agb/agb_{}_tif'.format(vec_lyr),
                                  out_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_agb/agb_{}_tif_chkd'.format(vec_lyr))
        ...
        for vec_lyr in vec_lyrs:
            self.gen_command_info(val_tiles='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/hmax_{}/*.kea'.format(vec_lyr),
                                  tif_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/hmax_{}_tif'.format(vec_lyr),
                                  out_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/hmax_{}_tif_chkd'.format(vec_lyr))
        ...
        for vec_lyr in vec_lyrs:
            self.gen_command_info(val_tiles='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/hba_{}/*.kea'.format(vec_lyr),
                                  tif_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/hba_{}_tif'.format(vec_lyr),
                                  out_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/hba_{}_tif_chkd'.format(vec_lyr))
        ...
        for vec_lyr in vec_lyrs:
            self.gen_command_info(val_tiles='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/hchm_{}/*.kea'.format(vec_lyr),
                                  tif_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/hchm_{}_tif'.format(vec_lyr),
                                  out_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/hchm_{}_tif_chkd'.format(vec_lyr))
