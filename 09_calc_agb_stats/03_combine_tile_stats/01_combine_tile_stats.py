...
stats_tiles = glob.glob('/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/stats/tile_stats/*.json')
...
for stats_tile_file in stats_tiles:
    ...
    for year in gmw_years:
        ...
        for val in unq_cntry_vals:
            ...
            tile_stats_lut[year_str][val]['area'] += stats_tile_lut[year_str][val]['area']
            tile_stats_lut[year_str][val]['vals'] += stats_tile_lut[year_str][val]['vals']
            tile_stats_lut[year_str][val]['vals_area'] += stats_tile_lut[year_str][val]['vals_area']

rsgislib.tools.utils.write_dict_to_json(tile_stats_lut, '/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/stats/country_agb_stats.json')
