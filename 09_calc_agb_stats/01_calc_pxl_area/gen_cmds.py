...
class GenTaskCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(srtm_tiles='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/srtm/gmw_srtm_kea/*.kea',
                              out_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/stats/pxl_area')

        self.pop_params_db()
        self.create_slurm_sub_sh("calc_pxl_area", 8224, '/scratch/a.pfb/gmw_simard_etal_srtm_agb/logs',
