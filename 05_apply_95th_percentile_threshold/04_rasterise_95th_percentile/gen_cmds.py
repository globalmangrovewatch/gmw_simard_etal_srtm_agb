...
class GenTaskCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(srtm_tiles='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/srtm/gmw_srtm_kea/*.kea',
                              countries_vec_file="/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/countries/GADM_EEZ_WCMC_4326_UnqID.gpkg",
                              countries_vec_lyr="National",
                              percent_95th_col="percent95th",
                              out_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/srtm/srtm_95th_percent_thres')


        self.pop_params_db()
        self.create_slurm_sub_sh("rasterise_95th_percent", 8224, '/scratch/a.pfb/gmw_simard_etal_srtm_agb/logs',
