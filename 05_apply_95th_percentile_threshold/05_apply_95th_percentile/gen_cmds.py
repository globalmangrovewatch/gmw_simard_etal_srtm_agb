...
class GenTaskCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for srtm_tile in srtm_tiles:
            ...
            percent95th_img = os.path.join(kwargs['percent95th'], "{}_95thpercent.kea".format(tile_base_name))
            out_img = os.path.join(kwargs['out_path'], "{}_95thp_thresholded.kea".format(tile_base_name))
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(srtm_tiles='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/srtm/gmw_srtm_kea/*.kea',
                              percent95th="/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/srtm/srtm_95th_percent_thres",
                              out_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/srtm/srtm_95thpercent')
