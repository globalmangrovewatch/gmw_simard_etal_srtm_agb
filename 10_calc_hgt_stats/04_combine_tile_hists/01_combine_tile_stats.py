...
for val in unq_cntry_vals:
    tile_stats_lut[val] = numpy.zeros((71), dtype=numpy.uint32)

stats_tiles = glob.glob('/home/pete/Documents/gmw_v3_agb_hgt/stats/hist_hchm_tile_stats/*.json')
...
rsgislib.tools.utils.write_dict_to_json(tile_stats_lut, '/home/pete/Documents/gmw_v3_agb_hgt/stats/country_hchm_hists.json')
