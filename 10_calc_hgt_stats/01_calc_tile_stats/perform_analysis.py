...
def calc_unq_val_pxl_areas(vals_img, uid_img, gmw_img, unq_val_area_lut):
...
class PerformAnalysis(PBPTQProcessTool):
    ...
    def do_processing(self, **kwargs):
        ...
        for gmw_year in self.params["gmw_ext_imgs"]:
            ...
            calc_unq_val_pxl_areas(self.params["agb_tile"], self.params["cntry_img"], gmw_ext_img, lut_vals)
    ...
    def required_fields(self, **kwargs):
        return ["agb_tile", "country_ids_lut_file", "cntry_img", "gmw_ext_imgs", "out_file"]
