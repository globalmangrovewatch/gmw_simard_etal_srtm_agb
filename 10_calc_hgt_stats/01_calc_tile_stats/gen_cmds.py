...
class GenTaskCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for agb_tile in agb_tiles:
            tile_base_name = rsgislib.tools.filetools.get_file_basename(agb_tile).replace("_srtm_gmw_hchm", "")
            ...
            out_file = os.path.join(kwargs['out_path'], "{}_gmw_v314_hchm_stats.json".format(tile_base_name))
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(agb_tiles='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/gmw_srtm_mangrove_hgt/gmw_union_hchm/*.kea',
                              ...
                              out_path='/scratch/a.pfb/gmw_simard_etal_srtm_agb/data/stats/tile_hchm_stats')

        self.pop_params_db()
        self.create_slurm_sub_sh("calc_hchm_stats", 8224, '/scratch/a.pfb/gmw_simard_etal_srtm_agb/logs',
